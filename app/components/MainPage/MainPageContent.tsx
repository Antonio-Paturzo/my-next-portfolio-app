...
export default function MainPageContent({ projects }: { projects: any[] }) {
  return (
    <div
      id="link1"
      className="relative isolate overflow-hidden bg-primary-dark px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0"
    >
      <div className="absolute inset-0 -z-10 overflow-hidden blur-2xl">
        <svg
          className="absolute left-[max(50%,25rem)] top-24 h-[64rem] w-[128rem] -translate-x-1/2 stroke-violet-400 [mask-image:radial-gradient(64rem_64rem_at_top,white,transparent)]"
          aria-hidden="true"
        >
          <defs>
            <pattern
          ...
          <svg x="50%" y={-1} className="overflow-visible fill-violet-400">
            <path
