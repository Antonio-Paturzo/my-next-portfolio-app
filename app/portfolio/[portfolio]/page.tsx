...
export default async function Project({ params }: Props) {
  ...
  return (
    <div>
      <Header />
      <div className="h-full relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
        <svg
